...
//请注意，从 MyBatis-Plus 3.x 版本开始，QueryWrapper 替代了旧版本中的 EntityWrapper   下面的可能也要改  EntityWrapper 都改成了 QueryWrapper
...
import java.lang.annotation.*;   //字写的注解
...
public class YonghuController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		YonghuEntity user = yonghuService.selectOne(new QueryWrapper<YonghuEntity>().eq("zhanghao", username));
